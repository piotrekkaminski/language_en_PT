...
# Version & progress
This translation is generated from the branch [Head](https://crowdin.com/project/magento-2/en-PT#/Head) at Crowdin and based on the Magento Head sourcefiles.
...
# Contribute
To help move the '*English (English) Magento2 Language Pack (en_PT)*' forward please goto [this](https://crowdin.com/project/magento-2/en-PT) crowdin page and translate the untranslated string or propose better translations.
